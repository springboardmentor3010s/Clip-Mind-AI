  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 py-8 mt-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-text-secondary font-light">Monitor engagement and video performance.</p>
      </div>
      ...
      <div className="glass-panel border border-white/5 rounded-[2rem] p-16 text-center flex flex-col items-center justify-center glow-effect mt-8">
        <div className="w-24 h-24 bg-accent/10 rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(139,92,246,0.2)]">
          <span className="material-symbols-outlined text-5xl text-accent">analytics</span>
        </div>
        <h3 className="text-3xl font-bold text-white mb-4">Coming Soon</h3>
        <p className="text-text-secondary mb-10 max-w-lg text-lg">Detailed video analytics and engagement metrics will be available in the next release.</p>
